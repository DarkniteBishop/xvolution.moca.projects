...
{ 
    [insert into wh_serv_exitpnt_arecod
            (serv_id, wh_id, exitpnt_typ, exitpnt, srcare, dstare, moddte, mod_usr_id)
         VALUES
            ('@serv_id@', '@wh_id@', '@exitpnt_typ@', '@exitpnt@', '@srcare@', '@dstare@', to_date('@moddte@','YYYYMMDDHH24MISS'), '@mod_usr_id@') ] 
}
